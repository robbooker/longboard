...
export default function LoginForm({ chatEntry = false, fontClass = "", chatBackHref = "/chat/login" }: { chatEntry?: boolean; fontClass?: string; chatBackHref?: string }) {
  ...
  return (
    <div className={`login-page ${chatEntry ? styles.chatForm : ""} ${fontClass}`}>
      <style>{`
        .login-page {
          --cream:#F6F2E9;
          --card:#FBF8F0;
          ...
          <div className="lp-card">
            <div className="lp-brand">
              <div className="lp-brand-inner">
                <div className="lp-eyebrow-amber">{chatEntry ? "LONGBOARD CHAT · MEMBER ACCESS" : "● THE DAILY BRIEF · MEMBERS"}</div>
                <h1 className="lp-h1">
                  {chatEntry ? <>WELCOME<br />TO YOUR<br /><span className="lp-h1-italic">COMMUNITY.</span></> : <>Welcome back.{" "}<span className="lp-h1-italic">Let&rsquo;s play the long game.</span></>}
                </h1>
                <p className="lp-dek">
                  {chatEntry ? "Sign in to talk markets, share ideas, and catch up with your people." : "Sign in for today’s plan, your archive, and the open-bell pulse."}
                </p>
              </div>
            ...
            <div className="lp-form-panel">
              <div className="lp-form-eyebrow">{chatEntry ? "SIGN IN WITH LONGBOARD" : "● SIGN IN"}</div>
              ...
              <div className="lp-members-only">{chatEntry ? <Link href={chatBackHref}>← Choose another membership</Link> : "● MEMBERS ONLY"}</div>
            </div>
          </div>
