...
The migration digest is pinned in the per-ticket release manifest. Its public login probe is smoke coverage, not authenticated acceptance. Voice-first integration and a full refreshed validation remain the coordinator's integration step.
