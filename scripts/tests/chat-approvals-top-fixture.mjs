...
const source=(await readFile(new URL('chat-mobile-fixture.mjs',import.meta.url),'utf8')).replaceAll('54404',process.env.TEST_REST_PORT||'54476').replaceAll('3204',process.env.TEST_CHAT_PORT||'3276');
