...
sources:
  - author: "Albert Bandura"
    ...
    year: 1977
    gloss: "the original framework arguing that mastery experiences, not pep talks or affirmations, are the primary source of durable belief in one's own capability."
  - author: "Edwin A. Locke and Gary P. Latham"
    title: "Building a practically useful theory of goal setting and task motivation"
    year: 2002
    gloss: "the paper that made the case for specific, difficult, but *attainable* goals over vague aspirations."
  - author: "Peter M. Gollwitzer and Paschal Sheeran"
    ...
    year: 2006
    gloss: "useful for the idea that pre-commitment to small executable steps outperforms big emotional declarations."
