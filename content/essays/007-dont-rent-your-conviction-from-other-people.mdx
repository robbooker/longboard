...
sources:
  - author: "Solomon E. Asch"
    ...
    year: 1956
    gloss: "The original conformity experiments. Roughly 37% of responses conformed to an obviously wrong group answer. In markets, where the right answer is not obvious, the conformity rate is presumably worse."
  - author: "Robert B. Cialdini"
    title: "Influence: The Psychology of Persuasion"
    year: 2006
    gloss: "Social proof as one of six major persuasion mechanisms. Useful here for the idea that popularity functions as a heuristic even when popularity has no relationship to correctness."
  - author: "Amos Tversky and Daniel Kahneman"
    title: "Judgment under uncertainty: Heuristics and biases"
    year: 1974
    gloss: "The anchoring effect is relevant: other people's price targets and opinions become cognitive anchors that distort your own analysis even when you believe you are thinking independently."
