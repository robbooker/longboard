// Archived: the previous /learn index page (Phase 3H), preserved here
// for one commit cycle during the Phase 3L rollout as a rollback
// fallback. The Daily homepage in app/learn/page.tsx replaces this
// surface. Per the Phase 3L handoff, this directory gets deleted
// during Commit 6's QA/cleanup.
//
// _archive/ is a Next.js private folder (underscore prefix) so this
// page.tsx will NOT register as a route — it's inert dead code until
// deleted.
...
export default async function LearnIndexPageArchived() {
