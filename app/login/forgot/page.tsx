  ...
  return (
    <div className="login-page">
      <style>{`
        ...
        .login-page .lp-back-link:hover{opacity:.55}
          ...
          <div className="lp-card">
            <div className="lp-brand">
              <div className="lp-brand-inner">
                <div className="lp-eyebrow-amber">● PASSWORD RESET · MEMBERS</div>
                <h1 className="lp-h1">
                  Forgot the password?{" "}
                  <span className="lp-h1-italic">Easy fix.</span>
                </h1>
                <p className="lp-dek">
                  We&rsquo;ll send a reset link to your email. Click it. You&rsquo;re back.
                </p>
              </div>
            ...
            <div className="lp-form-panel">
              {sent ? (
                <>
                  <div className="lp-form-eyebrow">● LINK SENT</div>
                  <p className="lp-success">
                    If an account exists for{" "}
                    <span className="lp-success-email">{email}</span>, a reset
                    link is on its way. Check your email and click the link to
                    set a new password.
                  </p>
                </>
              ) : (
                <>
                  <div className="lp-form-eyebrow">● RESET LINK</div>
                  ...
                  <form onSubmit={handleSubmit}>
                    <div>
                      <label htmlFor="lf-email" className="lp-label">EMAIL</label>
                      <input
                        id="lf-email"
                        className="lp-input"
                        type="email"
              ...
              <Link href="/login" className="lp-back-link">← BACK TO SIGN IN</Link>
            </div>
          </div>
